...
Our methodology is to extend our new floating point library in Lean \cite{fplean}
...
\paragraph{Floating Point Rewrites from Bitwuzla}
...
\paragraph{Counterexample Guided Lazy Unfolding}
