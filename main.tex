...
\begin{itemize}
  ...
  \item Cash Funding Needed: \lies{£136,000}
  \item AWS Promotional Credits needed: \lies{\$255,500}
  \item Amazon contact: Daniel Kroenig, \lies{\texttt{XXXXXX@amazon.com}}
\end{itemize}
...
Nect, to strengthen our bitblasting pipeline, we will incorporate
...
(a) First, a mechanization of fixed point arithmetic, build on top of the dyadic rational 
...
(c) A mechanization of the reuduction from floating point to fixed point arithmetic,
following the SymFPU approach \cite{symfpu}. 
